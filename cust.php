...
function savecust(){
	$('#fform').attr('onsubmit', 'aaa');
 var cname=$("#cname").val();
var caddr=$("#caddr").val();
var ccont=$("#ccont").val();
//alert(desi+"xxx"+j_desc+"xxx"+loc+"xxx"+j_quali+"xxx"+j_skill+"xxx"+j_expi+"xxx"+nop);
	if(cname!="" && caddr!="" && ccont!="" && cdairy!="" && pass!="" ){
		var form = $("#fform");
	$.ajax({
            type: 'POST',
            url: 'save_cust.php',
		  ...
		  if(data == "Success")
		{ 
		$('#fform').attr('onsubmit', 'savecust()');
		  $('#fform')[0].reset();
			$('#sucess').text("Customer Added Successfully");
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                ...
                <form id="fform" action='javascript:;' name="fform" onsubmit="savecust()" Method="POST" enctype="multipart/form-data">
						<input type="text" id="cname" class="form-control" name="cname" style="margin-bottom:10px;" value="" placeholder="Customer Name"/>
						
						<textarea  placeholder="Customer address" id="caddr" class="form-control" name="caddr" style="margin-bottom:10px;" value=""></textarea>
						
						<input type="text" id="ccont" class="form-control" name="ccont" maxlength="15" style="margin-bottom:10px;" onKeyPress="return isNumberKey(event);" value="" placeholder="Contact No"/>
						<input type="text" id="cdairy" class="form-control" name="cdairy" style="margin-bottom:10px;" value="" placeholder="Dairy Name"/>
						<input type="text" id="cgno" class="form-control" name="cgno" style="margin-bottom:10px;" value="" placeholder="Customer Area/Landmark"/>
						<input type="password" id="pass" class="form-control" name="pass" style="margin-bottom:10px;" value="" placeholder="Enter Password"/>
