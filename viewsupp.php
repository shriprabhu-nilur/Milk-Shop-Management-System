                    ...
                    <section class="wrapper site-min-height">
                        ...
                        <div class="directory-info-row">
                            <div class="row" id="view">
                               <?php
	$fetchsupp = $auth_user->fetchsupp($user_id);
	foreach ($fetchsupp as $fetchsuppdiv){
	$sname=$fetchsuppdiv['sname'];
	$sid=$fetchsuppdiv['sid'];
	$saddr=$fetchsuppdiv['saddr'];
	$sgno=$fetchsuppdiv['sgno'];
	$scont=$fetchsuppdiv['scont'];
	$sotp=$fetchsuppdiv['sotp'];
								?>
                                            ...
                                            <div class="panel-body">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <h4><?php echo $sname; ?> <span class="text-muted small"></span></h4>
                                                        <address>
                                      <strong style="font-size: 12px;">GST IN:<?php echo $sgno; ?></strong><br>
                                    <?php echo $saddr; ?><br/>
                                      <abbr title="Phone">P:</abbr> <?php echo $scont; ?>
									</address>
                                                        <ul class="social-links">
                                                            <li><a title="" data-placement="top" data-toggle="tooltip" class="tooltips" href="pslip?source_ref=<?php echo $sotp; ?>" data-original-title="Invoice"><i class="fa fa-book"></i></a></li>
