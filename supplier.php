...
//alert(desi+"xxx"+j_desc+"xxx"+loc+"xxx"+j_quali+"xxx"+j_skill+"xxx"+j_expi+"xxx"+nop);
	...
	$.ajax({
		  ...
		  if(data == "Success")
		{ 
		$('#fform').attr('onsubmit', 'savesupp()');
		  $('#fform')[0].reset();
			$('#sucess').text("Supplier Added Successfully");
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                ...
                <form id="fform" action='javascript:;' name="fform" onsubmit="savesupp()" Method="POST" enctype="multipart/form-data">
						<input type="text" id="sname" class="form-control" name="sname" style="margin-bottom:10px;" value="" placeholder="Supplier Name"/>
						
						<textarea  placeholder="Supplier address" id="saddr" class="form-control" name="saddr" style="margin-bottom:10px;" value=""></textarea>
						<input type="text" id="scont" class="form-control" name="scont" maxlength="15"  style="margin-bottom:10px;" onKeyPress="return isNumberKey(event);" value="" placeholder="Contact No"/>
						<input type="text" id="sgno" class="form-control" name="sgno" style="margin-bottom:10px;" value="" placeholder="Supplier GST No"/>
