...
//alert(desi+"xxx"+j_desc+"xxx"+loc+"xxx"+j_quali+"xxx"+j_skill+"xxx"+j_expi+"xxx"+nop);
	if(vhead!="" && vdesc!="" && vamount!="" && vby!="" ){
		var form = $("#fform");
	$.ajax({
            type: 'POST',
            url: 'save_vaucher.php',
            data: form.serialize(),
            success: function(data){  
			alert(data);
		  if(data == "Success")
		{ 
		$('#fform').attr('onsubmit', 'savevauch()');
		  $('#fform')[0].reset();
			$('#sucess').text("Vaucher Added Successfully");
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                ...
                <form id="fform" action='javascript:;' name="fform" onsubmit="savevauch()" Method="POST" enctype="multipart/form-data">
						<input type="text" id="vhead" class="form-control" name="vhead" style="margin-bottom:10px;" value="" placeholder="voucher Head"/>
						
						<textarea  placeholder="voucher Description" id="vdesc" class="form-control" name="vdesc" style="margin-bottom:10px;" value=""></textarea>
						
						<input type="text" id="vamount" class="form-control" name="vamount" maxlength="10" style="margin-bottom:10px;" value="" placeholder="voucher Amount"/>
						<input type="text" id="vby" class="form-control" name="vby" style="margin-bottom:10px;" value="" placeholder="voucher by"/>
