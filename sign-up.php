        ...
        <?php
			...
			?>
				...
				<div style="color: red; position: absolute; font-size: 15px; font-weight: 600; margin-top: -10px; margin-left: 35px; padding: 15px;"></div>
					<div class="head">
						<img src="views/img/klogo.png" alt=""/>
					</div>
				<form  method="POST">
					<li>
						<input type="text" class="text" name="txt_uname" placeholder="Enter Username" value="<?php if(isset($error)){echo $uname;}?>" /><a href="#" class=" icon user"></a>
					</li>
					<li>
						<input type="text" class="text" name="txt_umail" placeholder="Enter E-Mail ID" value="<?php if(isset($error)){echo $umail;}?>" /><a href="#" class=" icon user"></a>
					</li>
					<li>
